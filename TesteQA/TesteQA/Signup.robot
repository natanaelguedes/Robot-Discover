...
GO TO SIGNUP PAGE
FILL SIGNUP FORM      ${name}    ${email}    ${cpf}    ${cep}  ${adressNumber}   ${addressDetails}    ${addressStreet}    ${addressDistrict}    ${addressCityUf}    ${addressNumber}     
SUBMIT SIGNUP FORM
...
FILL SIGNUP FORM
    [Arguments]    ${name}    ${email}    ${cpf}    ${cep}  ${adressNumber}   ${addressDetails}    ${addressStreet}    ${addressDistrict}    ${addressCityUf}    ${addressNumber}     
